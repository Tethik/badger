...
def get_percentage_badge(key, percentage):
    """
    Return badge with automatic color chosen based on percentage (100% = green, 0% = red)
    """
    return get_badge(key, str(int(percentage)) + "%", color=get_color(percentage))
